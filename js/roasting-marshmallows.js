...
var tlcharacterEyes = new TimelineMax({
    repeat: -1
});
tlcharacterEyes.to(characterEyes, .2, {
    opacity: 0
}, 4)
tlcharacterEyes.to(characterEyes, .2, {
    opacity: 1
...
tlbearAppear.to(bearBrows, .5, {
    y: -2,
    ease: Back.easeOut.config(2)
}, 1)
tlbearAppear.to(bearBrows, .4, {
    y: 0
}, 3)
...
var tlbearBlink = new TimelineMax({
    repeat: -1
});
tlbearBlink.to(bearEyes, .2, {
    opacity: 0
}, 4)
tlbearBlink.to(bearEyes, .2, {
    opacity: 1
